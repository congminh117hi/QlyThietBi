...
namespace QuanLyThietBi.DAO
{
    class LienKetCSDL
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = "Data Source=CONG-MINH\\SQLEXPRESS;Initial Catalog=QuanLyThietBi;Integrated Security=True";
            Con.Open();                  //Mở kết nối
            //Kiểm tra kết nối
        ...
        public static DataTable GetDataToTable(string sql)
        {
            ...
            MyData.SelectCommand.Connection = LienKetCSDL.Con; //Kết nối cơ sở dữ liệu
        ...
        public static void RunSqlDel(string sql)
        {
            ...
            cmd.Connection = LienKetCSDL.Con;
            cmd.CommandText = sql;
            try
            {
                cmd.ExecuteNonQuery();

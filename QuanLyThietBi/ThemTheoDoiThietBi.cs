...
{
    public partial class ThemTheoDoiThietBi : Form
    {
        public ThemTheoDoiThietBi()
        {
            InitializeComponent();
        ...
        private void btnThemtheodoiTB_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int Mathietbisudung = (cboTenTBsudung.SelectedItem as DTO.ThietBiSuDung).Mathietbisudung;

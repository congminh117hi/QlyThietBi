...
{
    public partial class PhieuNhapThietBi : Form
    {
        DataTable CTPN;
        ...
        private void btnChonTB_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int Mathietbisudung = (cboMaTBsudung.SelectedItem as DTO.ThietBiSuDung).Mathietbisudung;
        ...
        private void cboMaTBsudung_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            int Mathiebisudung = (cboMaTBsudung.SelectedItem as DTO.ThietBiSuDung).Mathietbisudung;
